  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: authService.isLoggedIn
          ? ProductPage(authService: authService)
...
class ProductPage extends StatelessWidget {
  ...
  ProductPage({Key? key, required this.authService}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tezeda Store'),
        actions: [
          IconButton(
...
//Authenticate with Fakestore Users


// Add ProductWidget and ProductDetails classes as before
